...
public abstract class CrossValidationWrapper<LearningStruct> {
    /*public abstract class ParamIterator{
        public abstract boolean hasNext();
        public abstract double[] getNext();
        public abstract void init();
        public abstract int size();
        public abstract double[] getParamAtIdx(int id);
    }
    public abstract class myLearner<T>{
        public abstract void learn(T example);
        public abstract String predict(T example);
        public abstract void save(String dir,String name);
    }*/
    public class PerformanceRecorder{
        ...
        public void add_paramId_fold(int paramId, int fold, double performance, double[] params){
            param_fold_performance[paramId][fold] = performance;
        ...
        for(int n=0;n<n_param;n++){
            ...
            if(mode==0) {
                for (int f = 0; f < TotalFold; f++) {
                    ...
                    performanceRecorder.add_paramId_fold(n, f, performance,param);
                }
            }
            else if(mode==1){
                ...
                double performance = evaluate(devSplits,0);
                performanceRecorder.add_paramId_fold(n, 0, performance,param);
            }
        }
