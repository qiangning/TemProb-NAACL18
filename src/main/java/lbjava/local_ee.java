...
public class local_ee extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee(true);
  }
  ...
  public static local_ee instance;

  public static local_ee getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee(boolean b)
  {
  ...
  public local_ee()
  {
    super("lbjava.local_ee");
    isClone = true;
  }

  public local_ee(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee(TemporalEventPair)' defined on line 214 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee \\");
    ...
    local_ee classifier = new local_ee();
  ...
  public int hashCode() { return "local_ee".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee(false).getParameters()); }
  }
}
