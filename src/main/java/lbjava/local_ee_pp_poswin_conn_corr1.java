...
public class local_ee_pp_poswin_conn_corr1 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_pp_poswin_conn_corr1(true);
  }
  ...
  public static local_ee_pp_poswin_conn_corr1 instance;

  public static local_ee_pp_poswin_conn_corr1 getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_pp_poswin_conn_corr1(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_pp_poswin_conn_corr1";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_pp_poswin_conn_corr1$$1());
    isClone = false;
  }
  ...
  public local_ee_pp_poswin_conn_corr1()
  {
    super("lbjava.local_ee_pp_poswin_conn_corr1");
    isClone = true;
  }

  public local_ee_pp_poswin_conn_corr1(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_pp_poswin_conn_corr1(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_pp_poswin_conn_corr1.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr1.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr1.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_pp_poswin_conn_corr1";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee_pp_poswin_conn_corr1(TemporalEventPair)' defined on line 221 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_pp_poswin_conn_corr1 \\");
    ...
    local_ee_pp_poswin_conn_corr1 classifier = new local_ee_pp_poswin_conn_corr1();
  ...
  public int hashCode() { return "local_ee_pp_poswin_conn_corr1".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_pp_poswin_conn_corr1; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_pp_poswin_conn_corr1(false).getParameters()); }
  }
}
