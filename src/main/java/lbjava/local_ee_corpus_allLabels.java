...
public class local_ee_corpus_allLabels extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_corpus_allLabels(true);
  }
  ...
  public static local_ee_corpus_allLabels instance;

  public static local_ee_corpus_allLabels getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_corpus_allLabels(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_corpus_allLabels";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_corpus_allLabels$$1());
    isClone = false;
  }
  ...
  public local_ee_corpus_allLabels()
  {
    super("lbjava.local_ee_corpus_allLabels");
    isClone = true;
  }

  public local_ee_corpus_allLabels(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_corpus_allLabels(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_corpus_allLabels.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_corpus_allLabels.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_corpus_allLabels.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_corpus_allLabels";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee_corpus_allLabels(TemporalEventPair)' defined on line 242 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_corpus_allLabels \\");
    ...
    local_ee_corpus_allLabels classifier = new local_ee_corpus_allLabels();
  ...
  public int hashCode() { return "local_ee_corpus_allLabels".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_corpus_allLabels; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_corpus_allLabels(false).getParameters()); }
  }
}
