...
public class local_ee_pp_poswin_conn_corr_allE0 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_pp_poswin_conn_corr_allE0(true);
  }
  ...
  public static local_ee_pp_poswin_conn_corr_allE0 instance;

  public static local_ee_pp_poswin_conn_corr_allE0 getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_pp_poswin_conn_corr_allE0(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_pp_poswin_conn_corr_allE0";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_pp_poswin_conn_corr_allE0$$1());
    isClone = false;
  }
  ...
  public local_ee_pp_poswin_conn_corr_allE0()
  {
    super("lbjava.local_ee_pp_poswin_conn_corr_allE0");
    isClone = true;
  }

  public local_ee_pp_poswin_conn_corr_allE0(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_pp_poswin_conn_corr_allE0(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_pp_poswin_conn_corr_allE0.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr_allE0.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr_allE0.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_pp_poswin_conn_corr_allE0";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'local_ee_pp_poswin_conn_corr_allE0(TemporalEventPair)' defined on line 309 of local_ee.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof TemporalEventPair[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof TemporalEventPair || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_pp_poswin_conn_corr_allE0 \\");
    ...
    local_ee_pp_poswin_conn_corr_allE0 classifier = new local_ee_pp_poswin_conn_corr_allE0();
  ...
  public int hashCode() { return "local_ee_pp_poswin_conn_corr_allE0".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_pp_poswin_conn_corr_allE0; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_pp_poswin_conn_corr_allE0(false).getParameters()); }
  }
}
