...
public class local_ee_pp_poswin_conn_corr extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_pp_poswin_conn_corr(true);
  }
  ...
  public static local_ee_pp_poswin_conn_corr instance;

  public static local_ee_pp_poswin_conn_corr getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_pp_poswin_conn_corr(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_pp_poswin_conn_corr";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_pp_poswin_conn_corr$$1());
    isClone = false;
  }
  ...
  public local_ee_pp_poswin_conn_corr()
  {
    super("lbjava.local_ee_pp_poswin_conn_corr");
    isClone = true;
  }

  public local_ee_pp_poswin_conn_corr(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_pp_poswin_conn_corr(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_pp_poswin_conn_corr.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_pp_poswin_conn_corr.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_pp_poswin_conn_corr";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee_pp_poswin_conn_corr(TemporalEventPair)' defined on line 207 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_pp_poswin_conn_corr \\");
    ...
    local_ee_pp_poswin_conn_corr classifier = new local_ee_pp_poswin_conn_corr();
  ...
  public int hashCode() { return "local_ee_pp_poswin_conn_corr".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_pp_poswin_conn_corr; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_pp_poswin_conn_corr(false).getParameters()); }
  }
}
