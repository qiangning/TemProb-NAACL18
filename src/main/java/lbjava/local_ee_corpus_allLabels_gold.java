...
public class local_ee_corpus_allLabels_gold extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_corpus_allLabels_gold(true);
  }
  ...
  public static local_ee_corpus_allLabels_gold instance;

  public static local_ee_corpus_allLabels_gold getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_corpus_allLabels_gold(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_corpus_allLabels_gold";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_corpus_allLabels_gold$$1());
    isClone = false;
  }
  ...
  public local_ee_corpus_allLabels_gold()
  {
    super("lbjava.local_ee_corpus_allLabels_gold");
    isClone = true;
  }

  public local_ee_corpus_allLabels_gold(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_corpus_allLabels_gold(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_corpus_allLabels_gold.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_corpus_allLabels_gold.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_corpus_allLabels_gold.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_corpus_allLabels_gold";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee_corpus_allLabels_gold(TemporalEventPair)' defined on line 249 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_corpus_allLabels_gold \\");
    ...
    local_ee_corpus_allLabels_gold classifier = new local_ee_corpus_allLabels_gold();
  ...
  public int hashCode() { return "local_ee_corpus_allLabels_gold".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_corpus_allLabels_gold; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_corpus_allLabels_gold(false).getParameters()); }
  }
}
