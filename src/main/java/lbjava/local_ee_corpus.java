...
public class local_ee_corpus extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new local_ee_corpus(true);
  }
  ...
  public static local_ee_corpus instance;

  public static local_ee_corpus getInstance()
  {
    loadInstance();
    return instance;
  }

  private local_ee_corpus(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.eeLearningRate, 0, ParamLBJ.eeThickness));
    containingPackage = "lbjava";
    name = "local_ee_corpus";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new local_ee_corpus$$1());
    isClone = false;
  }
  ...
  public local_ee_corpus()
  {
    super("lbjava.local_ee_corpus");
    isClone = true;
  }

  public local_ee_corpus(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public local_ee_corpus(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(local_ee_corpus.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(local_ee_corpus.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(local_ee_corpus.class, lexiconPath));
    }
    else {
      containingPackage = "lbjava";
      name = "local_ee_corpus";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalEventPair || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'local_ee_corpus(TemporalEventPair)' defined on line 228 of local_ee.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: lbjava.local_ee_corpus \\");
    ...
    local_ee_corpus classifier = new local_ee_corpus();
  ...
  public int hashCode() { return "local_ee_corpus".hashCode(); }
  public boolean equals(Object o) { return o instanceof local_ee_corpus; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new local_ee_corpus(false).getParameters()); }
  }
}
